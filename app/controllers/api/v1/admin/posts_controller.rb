module Api::V1::Admin
  class PostsController < ApplicationController
    def index
      posts = current_user.posts.latest.with_attached_avatar.includes(:categories, :creator).page(params[:page])
    ...
    def post_params
      params.require(:post).permit(:title, :body, :avatar, category_ids: [])
    end
  end
end
